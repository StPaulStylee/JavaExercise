...
public class Main {
	...
	private static void SetCylinderType(Scanner inputManager) {
		try {
			...
			if (notationType != 0 && notationType != 1) {
				throw (new Exception("You must enter a single digit of either '0' or '1'. Please try again. FUCK HEAD!3"));
			}
			System.out.println("CylinderType: " + notationType);
		} catch (InputMismatchException e) {
			System.out.println("You must enter a single digit of either '0' or '1'. Please try again.");
		} catch (Exception e) {
